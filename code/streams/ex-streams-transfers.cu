...
int main() {
    ...
    for (int i = 0; i < numArrays; ++i) {
        //# TODO: replace new with cudaMallocHost for page-locked (pinned) host memory
    ...
    //# TODO: replace the three separate loops with a single loop that submits
    //#       H2D, kernel, and D2H for each work package to the same stream.
    ...
    for (int i = 0; i < numArrays; ++i) {
        //# TODO: replace delete[] with cudaFreeHost
        delete[] h_data[i];
